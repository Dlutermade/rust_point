...
export const Route = createFileRoute('/_layout/helps/page-editor')({
  head: () => ({ meta: [{ title: pageTitle('頁面編輯器說明') }] }),
      ...
      <Typography>
        ...
        <Steps
          ...
          items={[
            {
              title: '加積木',
              content: '左側積木庫「點一下」直接加到選中的容器，或「拖到畫布」放在想要的位置。',
            },
            {
              title: '選取一個積木',
              content: '點畫布上的積木、或點左側圖層樹。選中會出現藍框 + 一條就近工具列。',
            },
            {
              title: '就近工具列',
              content: '⠿ 拖曳排序、選父層（往上選容器）、上移 / 下移、複製、刪除。',
            },
            {
              title: '排版（容器）',
              content:
                '把積木拖進「容器（可水平 / 垂直）」或「疊層」；拖曳時會出現藍色插入線提示落點。',
            },
            {
              title: '調設定（右側面板）',
              content:
